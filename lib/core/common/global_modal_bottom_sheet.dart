                      ...
                      children: [
                        if (showTopDivider && enableDrag == true) ...[
                          Padding(
                            ...
                            child: Center(child: Assets.icons.divider.svg()),
                          )
                        ],
                        Row(
                          children: [
                            if (title != '') ...[
                              Expanded(
                                child: Center(
                                  child: Padding(
                                    padding: const EdgeInsets.only(bottom: kDefaultPadding, top: kDefaultMiddlePadding, left: kDefaultBiggerPadding),
                                    child: Text(
                                      title.tr(),
                                ...
                                child: GestureDetector(
                                  ...
                                  child: const Padding(
                                    padding: EdgeInsets.only(
                                        bottom: kDefaultPadding, top: kDefaultMiddlePadding, right: kDefaultInnerPadding, left: kDefaultPadding),
                                    child: FaIcon(
                      ...
                      if (showXmark) ...[
                        Align(
                          ...
                          child: GestureDetector(
                            ...
                            child: const Padding(
                              padding: EdgeInsets.only(bottom: kDefaultPadding, top: kDefaultMiddlePadding, right: kDefaultInnerPadding, left: kDefaultPadding),
                              child: FaIcon(
                                FontAwesomeIcons.xmark,
                              ),
                            ),
